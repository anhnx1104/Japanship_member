...
import { FormValueLogin } from 'pages/auth/login';
import type {
...
class Auth {
  public login(params: FormValueLogin) {
  ...
  public activeAccount(params: any) {
  ...
  public postLogout() {
    return HttpClient.post<CommonResponse<any>>(API_LOGOUT_PATH);
  }
